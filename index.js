...
// AssertionError: expected 'c' to equal 'cow' (so Imma need to split)
...
// const [red, orange, yellow, green, blue, violet] = colors.spit(" ") // LEARN did NOT like this. One cause it's not what it asked
